            ...
            {(!Array.isArray(orders) || orders.length === 0) ? (
               ...
               <div key={order.id} className="bg-backgroundSecondary border border-borderPrimary rounded-[2.5rem] p-8 shadow-sm hover:border-primary/40 transition-all group overflow-hidden relative">
                  ...
                  <div className="flex justify-between items-start mb-6">
                     ...
                     <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${order.status === 'PENDING' ? 'bg-amber-500/10 text-amber-600 border-amber-500/20' :
