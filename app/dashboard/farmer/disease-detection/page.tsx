    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12 print:hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 print:block">
        ...
        <div className="rounded-[2rem] border border-borderPrimary bg-backgroundSecondary shadow-sm p-6 sm:p-8 flex flex-col h-full print:hidden">
          ...
          <Link href="/dashboard/farmer/disease-history" className="w-full mt-6 py-3.5 rounded-xl border border-borderPrimary text-sm font-bold text-textSecondary hover:bg-hoverPrimary hover:border-primary/30 hover:text-primary transition-all flex items-center justify-center">
