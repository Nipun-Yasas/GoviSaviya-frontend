...
export default function FertilizerRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (files.length === 0) {
      setError(
        "Please upload at least one supporting document (e.g. Deed, NIC).",
      );
      return;
    }
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-textSecondary text-lg mb-8 text-center max-w-md">
          Your fertilizer request has been received and is currently being
          processed. You can track the status in your dashboard.
        </p>
        <button
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      <div className="max-w-4xl">
        ...
        <p className="text-textSecondary text-lg font-medium">
          Apply for subsidized fertilizer for your cultivation. Please provide
          accurate details and supporting documents.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <form
            ...
            className="bg-backgroundSecondary border border-borderPrimary rounded-[2.5rem] p-8 sm:p-10 shadow-sm space-y-8"
          >
            {error && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-textPrimary flex items-center gap-2 ml-1">
                  <FileText className="w-4 h-4 text-primary" /> Quantity
                  Requested
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-sm font-bold text-textPrimary flex items-center gap-2 ml-1">
                  <MessageSquare className="w-4 h-4 text-primary" /> Purpose for
                  Request
                </label>
                <textarea
                  name="purpose"
            ...
            <div className="space-y-4">
              <label className="text-sm font-bold text-textPrimary flex items-center gap-2 ml-1">
                <UploadCloud className="w-4 h-4 text-primary" /> Supporting
                Documents
              </label>
              ...
              >
                ...
                <p className="text-textSecondary text-xs mt-1">
                  Upload NIC, Land Deed, and other proofs (PDF, JPG, PNG)
                </p>
              </div>
              ...
              {files.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                  {files.map((file, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between p-3 bg-background border border-borderPrimary rounded-xl group hover:border-primary/30 transition-all"
                    >
                      <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-textSecondary uppercase font-black">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-[2rem] p-8">
            ...
            <p className="text-sm font-medium text-textSecondary leading-relaxed">
              By submitting this request, you certify that the information
              provided is true and accurate. Subsidized fertilizer is strictly
              for personal cultivation and cannot be resold.
            </p>
          </div>
        </div>
      </div>
