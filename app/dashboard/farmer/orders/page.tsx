            ...
            <tbody>
              {orders.length === 0 ? (
                ...
                <tr key={order.id} className="border-b border-borderPrimary hover:bg-hoverPrimary/20 transition-all group">
                  ...
                  <td className="p-6">
                    <span className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border ${order.status === 'PENDING' ? 'bg-amber-500/10 text-amber-600 border-amber-500/20' :
